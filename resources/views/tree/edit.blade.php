...
<div class="form-container col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-2 col-sm-offset-2 col-md-offset-2">
	...
	<div class="location-input col-md-12 col-sm-12 col-xs-12" style="padding: 0">
		<input id="q" placeholder="Ketikkan nama lokal atau ilmiah tanaman" class="form-control" type="search" name="q" autocomplete="off" value="{{ $tree->species->spesies }}">
		<button class="submit main-button" id="find-btn">Cek</button>
	</div>

	{!! Form::open(['onsubmit' => 'return check_data()', 'action' => ['TreeController@update', $tree->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) !!}
	<input type="hidden" id="species_id" name="species_id" value="{{ $tree->species_id }}" required>

	<div class="form-group">
		<div class="results col-md-12 col-sm-12 col-xs-12">
			<div class="well" style="display: block">
				<p style="color: green">Spesies tersedia. <a target="_blank" href="{{ route('species.edit', $tree->species_id) }}" style="color: green"><u>Edit taksonomi.</u></a></p>
			</div>
		</div>
	</div>
	...
	<div class="form-group">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<input type="text" class="form-control" placeholder="Nomor Registrasi" value="{{ $tree->id }}" disabled>
			{!! Form::hidden('id', $tree->id, ['required', 'id' => 'id', 'placeholder' => 'Nomor Registrasi', 'class' => 'form-control']) !!}
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<label for="tgl_tanam">Tanggal Tanam</label>
			{!! Form::date('tgl_tanam', $tree->tgl_tanam, ['id' => 'tgl_tanam', 'placeholder' => 'Tanggal Tanam', 'class' => 'form-control']) !!}
		</div>
	</div>
	...
	<div class="form-group">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			{!! Form::number('lat', $tree->latitude, ['id' => 'lat', 'min' => '-90', 'max' => '90', 'step' => '0.00000001', 'placeholder' => 'Latitude', 'class' => 'form-control']) !!}
			<p class="lat-msg input-error"></p>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			{!! Form::number('lng', $tree->longitude, ['id' => 'lng', 'min' => '-180', 'max' => '180', 'step' => '0.00000001', 'placeholder' => 'Longitude', 'class' => 'form-control']) !!}
			<p class="lng-msg input-error"></p>
		</div>
	</div>

	{!! Form::submit('Simpan', ['id' => 'form-submit', 'class' => 'main-submit']) !!}
	{!! Form::close() !!}
</div>
