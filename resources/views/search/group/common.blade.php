...
<div class="search-desc">
    <p>Spesies diawali dengan huruf {{ $letter }}, diurutkan berdasarkan nama lokal.</p>    
</div>
...
<div class="well item">
    ...
    <div class="desc col-lg-8 col-md-8 col-sm-8">
        <table>
            <tr>
                <td class="species" colspan="3" style="font-style: normal;">{{ $result->nama_lokal }}</td>
            </tr>
            <tr>
                <td class="desc-label">Nama Ilmiah</td>
                <td>:</td>
                <td class="desc-value" style="font-style: italic">{{ $result->spesies }}</td>
            </tr>
            <tr>
...
<ul class="pagination">
	...
	<li><a href="{{ route('species.common', $letter) }}">{{ $letter }}</a></li>
	@endforeach
</ul>
